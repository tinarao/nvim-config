	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				map("<leader>cr", require("telescope.builtin").lsp_references, "Go to references")

				-- Jump to the implementation of the word under your cursor.
				--  Useful when your language has ways of declaring types without an actual implementation.
				map("<leader>ci", require("telescope.builtin").lsp_implementations, "Go to implementations")
				...
				map("<leader>c;", require("telescope.builtin").lsp_type_definitions, "Go to type definition")
		...
		local servers = {
			...
			-- ts_ls = {},
			--
			-- Add html language server for HTML support
			html = {
				filetypes = {
					"html",
					"astro", -- Explicitly include astro
					"vue",
					"svelte",
				},
			},
